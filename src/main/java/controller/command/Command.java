...
public abstract class Command extends HttpServlet {
    ...
    public abstract void doGet(HttpServletRequest request, HttpServletResponse response, ServletContext servletContext) throws ServletException, IOException, JDBCConnectionException, DAOException;
